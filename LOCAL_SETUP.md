...
```
python3 esptool.py --chip esp8266 --port /dev/cu.usbserial-1110 --baud 115200 --before default_reset --after hard_reset write_flash -z --flash_mode dio --flash_freq 40m --flash_size 2MB 0x0 /Users/noahdohrmann/Dev/ESP/ESP8266_RTOS_SDK/examples/get-started/hello_world/build/bootloader/bootloader.bin 0x10000 /Users/noahdohrmann/Dev/ESP/ESP8266_RTOS_SDK/examples/get-started/hello_world/build/hello-world.bin 0x8000 /Users/noahdohrmann/Dev/ESP/ESP8266_RTOS_SDK/examples/get-started/hello_world/build/partitions_singleapp.bin
```
